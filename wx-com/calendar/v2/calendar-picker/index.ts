...
Component({
    ...
    methods: {
        ...
        formatDate(formats: string, date: Date) {
            let funs: any = {
                y: () => date.getFullYear()
                ,m: () => this.stringLPad(date.getMonth() + 1, '0', 2)
                ,d: () => this.stringLPad(date.getDate(), '0', 2)
                ,h: () => this.stringLPad(date.getHours(), '0', 2)
                ,i: () => this.stringLPad(date.getMinutes(), '0', 2)
                ,s: () => this.stringLPad(date.getSeconds(), '0', 2)
            };
